...
const areasCoordinates = [
  { name: "Windsor, NJ", lat: 40.2251, lng: -74.6193 },
  { name: "East Windsor, NJ", lat: 40.2657, lng: -74.5327 },
  { name: "West Windsor, NJ", lat: 40.2998, lng: -74.6194 },
  { name: "Princeton Junction, NJ", lat: 40.3182, lng: -74.6199 },
  { name: "Plainsboro, NJ", lat: 40.3318, lng: -74.5749 },
  { name: "Cranbury, NJ", lat: 40.3168, lng: -74.5071 },
  { name: "Hightstown, NJ", lat: 40.2673, lng: -74.5232 },
  { name: "Hamilton Township, NJ", lat: 40.2115, lng: -74.7035 },
  { name: "Lawrence Township, NJ", lat: 40.2893, lng: -74.7423 },
  { name: "Robbinsville Township, NJ", lat: 40.2143, lng: -74.619 },
  { name: "Twin Rivers, NJ", lat: 40.2645, lng: -74.4865 },
  { name: "Allentown, NJ", lat: 40.1773, lng: -74.5833 },
  { name: "Mercerville, NJ", lat: 40.2387, lng: -74.6974 },
  { name: "Dayton, NJ", lat: 40.382, lng: -74.5109 },
  { name: "Monroe Township, NJ", lat: 40.343, lng: -74.4415 },
];

function MapFlyTo({ selectedArea }) {
  const map = useMap();

  useEffect(() => {
    if (!selectedArea) return;
    map.flyTo([selectedArea.lat, selectedArea.lng], 12, {
      duration: 1.2,
    });
  }, [selectedArea, map]);
      ...
      <div className="relative overflow-hidden min-h-[460px] lg:min-h-[560px]">
        ...
        <div className="relative z-20 min-h-[460px] lg:min-h-[560px] px-[6%] pt-32 lg:pt-40 pb-16 flex items-center justify-center">
          <div className="w-full max-w-5xl mx-auto text-center">
            ...
            >
              Proudly Serving Windsor & Nearby Communities
            </motion.h1>
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="mt-4 text-base md:text-lg leading-relaxed text-[#5f6f60]">
              ...
              outdoor improvement, grading, and drainage services across
              Windsor and surrounding New Jersey communities.
            </p>
          </motion.div>
              ...
              <div className="rounded-[30px] border border-[#dfe7d7] bg-white/70 p-6 md:p-8 shadow-[0_16px_40px_rgba(32,45,35,0.08)] backdrop-blur-sm">
                <div className="mb-8">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#2f4633]">
                    Serving Windsor, NJ & Surrounding Areas
                  </h3>

                  <p className="mt-4 max-w-xl text-base md:text-lg leading-relaxed text-[#5f6f60]">
                    We proudly offer home renovation, grading, drainage, and
                    outdoor improvement services throughout Windsor and nearby
                    regions. If your area is not listed, contact us and we’ll
                    be happy to help.
                  </p>
                </div>
                  ...
                  {areasCoordinates.map((area, idx) => {
                    ...
                    return (
                      <button
                        ...
                        className={`group flex items-center gap-3 rounded-2xl border p-4 text-left transition duration-300 ${
                          isActive
          ...
          <div className="grid md:grid-cols-[1fr_auto] gap-6 items-center">
            <div>
              ...
              <p className="mt-3 text-base leading-relaxed text-[#5f6f60] max-w-2xl">
                Reach out to Aquanovus and we’ll confirm availability for your
