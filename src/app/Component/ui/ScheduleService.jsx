...
export default function ScheduleService() {
  ...
  const inquiryPreview = useMemo(() => {
    const fullName =
      `${form.firstName} ${form.lastName}`.trim() || "Client";
    const serviceText =
  ...
  return (
    <div className="w-full">
      <div className="rounded-[28px] border border-[#e6ece0] bg-white/85 p-5 sm:p-6 md:p-7 shadow-[0_16px_40px_rgba(32,45,35,0.06)] backdrop-blur-sm">
        {/* top summary */}
        <div className="mb-6 grid gap-4 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            ...
            <h3 className="mt-3 text-2xl sm:text-3xl font-bold tracking-tight text-[#2f4633]">
              Schedule Your Service
            </h3>

            <p className="mt-2 text-sm sm:text-base leading-relaxed text-[#5f6f60]">
        ...
        <form className="space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-[22px] bg-[#f7f5ef] p-4">
              <p className="text-sm leading-relaxed text-[#5f6f60]">
                All fields marked with an asterisk <span className="font-semibold">*</span> are required.
              </p>
            </div>
          </div>
          ...
          <motion.button
            ...
            className="group relative inline-flex w-full items-center justify-center gap-2 overflow-hidden rounded-full bg-gradient-to-r from-[#3f6b4b] via-[#4f7c57] to-[#6f8f4e] px-6 py-4 text-sm sm:text-base font-semibold text-white shadow-[0_12px_30px_rgba(34,60,40,0.22)] transition"
          >
