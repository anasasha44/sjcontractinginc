    ...
    <section className="relative overflow-hidden bg-[#f7f5ef] py-24 px-[6%]">
      ...
      >
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          >
            Professional Contracting & Outdoor Solutions
          </motion.h2>
          ...
          >
            Landscaping, contracting, and mobile mechanical services delivered
            with precision and long-term reliability across Canada.
          </motion.p>
          ...
          {servicesData.map((item) => {
            ...
            return (
              <motion.div
                ...
                className="group"
              >
                <div className="relative w-full h-[420px] overflow-hidden rounded-[28px] border border-[#dfe7d7] bg-white shadow-[0_15px_40px_rgba(32,45,35,0.10)]">
                  ...
                  {item.mainImage ? (
                    ...
                    <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-[#eaf2e6] to-[#f7f5ef]">
                      {Icon && (
                        <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#e3ecdc]">
                          <Icon className="text-2xl md:text-3xl text-[#3f6b4b]" />
                        </div>
                      )}
                    </div>
                  )}
